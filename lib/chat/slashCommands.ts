...
export const SLASH_COMMANDS = [
  ...
  { cmd: '/run',          desc: '/run [python code] — Python run karo browser mein', icon: '🐍' },
  { cmd: '/timer',        desc: '/timer [minutes] — Timer set karo',                   icon: '⏱️' },
  { cmd: '/todo',         desc: '/todo [task] — Task list mein add karo',              icon: '✅' },
  { cmd: '/translate',    desc: '/translate [text] — Hindi/English mein translate karo',   icon: '🌐' },
  { cmd: '/tts',          desc: '/tts [text] — Text sunao (TTS)',                          icon: '🔊' },
  { cmd: '/habits',       desc: 'Habit tracker kholo',                                     icon: '🔥' },
  { cmd: '/widgets',      desc: 'Live widgets dekho (gold, crypto, NEET countdown)',       icon: '🧩' },
  { cmd: '/image',        desc: '/image [prompt] — AI image studio kholega',               icon: '🎨' },
  { cmd: '/journal',      desc: 'Daily journal kholo',                                     icon: '📓' },
  { cmd: '/budget',       desc: 'Budget tracker kholo',                                    icon: '💰' },
  { cmd: '/music',        desc: 'Music player kholo',                                      icon: '🎵' },
  { cmd: '/games',        desc: 'Mini games kholo',                                        icon: '🎮' },
  { cmd: '/weather',      desc: '7-day forecast dekho',                                    icon: '🌤️' },
  { cmd: '/crypto',       desc: 'Crypto market dekho',                                     icon: '₿' },
  { cmd: '/write',        desc: 'AI writing assistant kholo',                              icon: '✍️' },
  { cmd: '/fitness',      desc: 'Workout tracker kholo',                                   icon: '💪' },
  { cmd: '/color',        desc: 'Color palette tool',                                      icon: '🎨' },
  { cmd: '/notes',        desc: 'Notes kholo',                                              icon: '📝' },
  { cmd: '/clear',        desc: '/clear — Chat clear karo',                            icon: '🗑️' },
  { cmd: '/mode',         desc: '/mode [flash/think/deep/auto] — Mode change karo',   icon: '⚡' },
  { cmd: '/py',           desc: '/py [code] — Python shortcut',                      icon: '🐍' },
  { cmd: '/pdf',          desc: '/pdf — Chat ko PDF mein export karo',               icon: '📄' },
  { cmd: '/calc',         desc: '/calc [expression] — Calculator (2+2, sqrt(16))',   icon: '🔢' },
